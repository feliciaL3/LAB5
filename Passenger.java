public class Passenger implements PhoneOwner{
    ...
    public static void AcceptedTheOffer(String FirstName ,String car, String car_type, String car_model) {
        System.out.println( "Passenger" +" " + FirstName +" "+ "agreed with price offer and  is ready to be picked up by the  car "+ car_model + " " + car_type +" .");
    }
